...
- 🌱 [Getting Started](/movie-maker/getting-started.md) - set up your first movie and learn the basics
- 🗺️ [Editor Map](/movie-maker/editor-map.md) - find your way around the interface
- 🔑 [Keyframe Editing](/movie-maker/keyframe-editing.md) - animate properties with keyframes
- 🖌️ [Motion Editing](/movie-maker/motion-editing.md) - fine-tune animations with curves and layers
- 🦴 [Skeletal Animation](/movie-maker/skeletal-animation.md) - animate characters with bones and IK
- 🎥 [Recording](/movie-maker/recording.md) - capture gameplay as animation data
- 🎞️ [Sequences](/movie-maker/sequences.md) - combine clips into multi-shot projects
- 📼 [Exporting Video](/movie-maker/exporting-video.md) - render to video files
- 🧑‍💻 [Playback API](/movie-maker/playback-api.md) - play movies from code
- 🧑‍💻 [Recording API](/movie-maker/recording-api.md) - record animations programmatically
