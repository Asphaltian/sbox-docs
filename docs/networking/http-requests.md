...
s&box provides a static [Http](https://sbox.game/api/Sandbox.Http) class, this lets you easily create asynchronous HTTP requests of different methods (GET, POST, DELETE, etc…) providing JSON content and parsing JSON responses.
