...
## [Attributes and Variables](/rendering/shaders/attributes-and-variables.md)

Passing data from C# into your shaders.

## [Material](/rendering/shaders/material.md)

Working with the Material struct and its properties.

## [Modes](/rendering/shaders/modes.md)

Shader render modes.

## [Shading Model](/rendering/shaders/shading-model.md)

Customizing how surfaces are lit.

## [Render States](/rendering/shaders/render-states.md)

Blending, depth, stencil, and culling state.

## [Sampler States](/rendering/shaders/sampler-states.md)

Texture sampler configuration.

## [GPU Instancing](/rendering/shaders/gpu-instancing.md)

Drawing many copies of a model in a single draw call.

## [Command Lists](/rendering/shaders/command-lists.md)

Deferred rendering commands attached to a camera.

## [Classes](/rendering/shaders/classes/index.md)

Built-in HLSL helper classes for lighting, motion, screen-space tracing and more.

## [Reference](/rendering/shaders/reference/index.md)
