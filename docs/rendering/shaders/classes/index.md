...
* 💡 [Light](/rendering/shaders/classes/light.md)
  * Iterating all light sources in your custom shader, understanding light data, sampling shadows, light contribution types, and separate directional light data   
